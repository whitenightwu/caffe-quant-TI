...
./tools/utils/create_segmentation_image_lmdb.py --rand_seed 1 --shuffle --label --height=480 --width=480 --list_file=$DATASETPATH/ImageSets/Segmentation/train.txt --image_dir=$DATASETPATH/SegmentationClass --search_string="*.png" --output_dir="data/train-label-lmdb"
./tools/utils/create_segmentation_image_lmdb.py --rand_seed 1 --shuffle --label --height=480 --width=480 --list_file=$DATASETPATH/ImageSets/Segmentation/val.txt --image_dir=$DATASETPATH/SegmentationClass --search_string="*.png" --output_dir="data/val-label-lmdb"
