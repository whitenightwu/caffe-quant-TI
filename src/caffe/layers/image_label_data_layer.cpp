...
template<typename Ftype, typename Btype>
void ImageLabelDataLayer<Ftype, Btype>::DataLayerSetUp(const vector<Blob*>& bottom,
...
template<typename Ftype, typename Btype>
void ImageLabelDataLayer<Ftype, Btype>::ShuffleImages() {
//  caffe::rng_t* prefetch_rng =
//      static_cast<caffe::rng_t*>(prefetch_rng_->generator());
//  shuffle(lines_.begin(), lines_.end(), prefetch_rng);
//  LOG(FATAL) <<
//      "ImageLabelDataLayer<Ftype>::ShuffleImages() is not implemented";
  caffe::rng_t* prefetch_rng =
      static_cast<caffe::rng_t*>(prefetch_rng_->generator());
...
template<typename Ftype, typename Btype>
void ImageLabelDataLayer<Ftype, Btype>::SampleScale(cv::Mat *image, cv::Mat *label) {
...
template<typename Ftype, typename Btype>
void ImageLabelDataLayer<Ftype, Btype>::ResizeTo(
    const cv::Mat& img,
    cv::Mat* img_temp,
    const cv::Mat& label,
    cv::Mat* label_temp,
