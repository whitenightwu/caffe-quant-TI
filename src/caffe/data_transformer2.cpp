...
void DataTransformer<Dtype>::TransformGPU(const TBlob<Dtype>* input_blob,
  ...
  TransformGPU(input_shape[0],
      input_shape[1],
      input_shape[2],
      input_shape[3],
      sizeof(Dtype),
      input_blob->gpu_data(),
      transformed_blob->mutable_gpu_data(false),
      randoms, use_mean);
}
#endif

template<typename Dtype>
void DataTransformer<Dtype>::Transform(const TBlob<Dtype>* input_blob,
    TBlob<Dtype>* transformed_blob, const std::array<unsigned int, 3>& rand, bool use_mean) {
...
template<typename Dtype>
void DataTransformer<Dtype>::TransformCPU(const TBlob<Dtype>* input_blob,
      TBlob<Dtype>* transformed_blob, const std::array<unsigned int, 3>& rand, bool use_mean) {
...
template void DataTransformer<float>::Transform(const TBlob<float>* input_blob,
    TBlob<float>* transformed_blob, const std::array<unsigned int, 3>& rand, bool use_mean);
template void DataTransformer<float16>::Transform(const TBlob<float16>* input_blob,
    TBlob<float16>* transformed_blob, const std::array<unsigned int, 3>& rand, bool use_mean);
template void DataTransformer<double>::Transform(const TBlob<double>* input_blob,
    TBlob<double>* transformed_blob, const std::array<unsigned int, 3>& rand, bool use_mean);
